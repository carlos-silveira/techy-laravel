...
import { a as AnimatePresence, i as ArrowRight } from "./x-DrxCXmes.mjs";
import { n as useMotionTemplate, r as useScroll, t as useTransform } from "./use-transform-CDErdClp.mjs";
import { t as useMotionValue } from "./use-motion-value-B5SU4CfM.mjs";
import { t as useSpring } from "./use-spring-DhkN-K6g.mjs";
...
import { t as GenIcon } from "./iconBase-zo8gDl5C.mjs";
import { n as Navbar, t as PublicFooter } from "./PublicFooter-CkqyKYTB.mjs";
import { t as CommandPalette } from "./CommandPalette-BfligKcY.mjs";
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: __("At TechyNews, our goal is to deliver timely, accurate, and insightful technology news. To achieve this at scale while maintaining high quality, we employ a hybrid editorial model.")
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "text-[20px] font-medium text-black dark:text-white mb-4",
										children: __("AI-Assisted Journalism")
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-[16px] text-gray-700 dark:text-gray-300 font-light leading-[1.8] mb-6",
										children: __("We utilize advanced artificial intelligence models to help draft, format, and translate our articles. However, AI is strictly a tool in our workflow, not an autonomous publisher. Every piece of content is guided by human editorial intent.")
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "text-[20px] font-medium text-black dark:text-white mb-4",
										children: __("Fact-Checking & Human Review")
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-[16px] text-gray-700 dark:text-gray-300 font-light leading-[1.8] mb-6",
										children: __("We cross-reference multiple authoritative sources to ensure the factual accuracy of our reports. Our proprietary fact-checking pipeline evaluates the validity of the information before publication. The final analysis, \"The TechyNews Take\", and market context are overseen by our editorial team to provide genuine value to our readers.")
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "text-[20px] font-medium text-black dark:text-white mb-4",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: __("We believe in total transparency. While you may see AI-generated summaries or translated text, you can trust that the core reporting, opinions, and analyses reflect the expertise of the TechyNews editorial board.")
									})
								]
							})]
						}),
