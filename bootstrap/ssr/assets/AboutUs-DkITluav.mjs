...
import Layout from "./Layout-J9PEkCSD.mjs";
import { FaLinkedin } from "react-icons/fa/index.esm.js";
import "./TopNav-BwTmCMc4.mjs";
import "./Footer-nKv9BgXK.mjs";
function AboutUs() {
  ...
  return /* @__PURE__ */ jsx(Layout, { children: /* @__PURE__ */ jsxs("main", { children: [
    /* @__PURE__ */ jsx("section", { id: "intro", className: "bg-gray-100 py-16", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold mb-4", children: content[language].intro }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center mt-8", children: /* @__PURE__ */ jsxs("a", { href: "https://www.linkedin.com/in/carlos-silveira-hinojos/", target: "_blank", rel: "noopener noreferrer", className: "bg-blue-500 text-white font-semibold py-2 px-4 rounded-md flex items-center hover:bg-blue-600 transition duration-300", children: [
        /* @__PURE__ */ jsx(FaLinkedin, { className: "mr-2" }),
        content[language].linkedin
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { id: "experience", className: "py-16", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold mb-4", children: language === "es" ? "Experiencia" : "Experience" }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: content[language].experience.map((exp, index) => /* @__PURE__ */ jsxs("div", { className: "border p-6 rounded-md shadow-md", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsx("img", { src: exp.logo, alt: `Logo de ${exp.company}`, className: "w-8 h-8" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-600 font-medium", children: exp.period })
        ] }),
        /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-2", children: exp.company }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-800 mb-4 font-medium", children: exp.role }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-800", children: exp.description })
      ] }, index)) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { id: "education-certifications", className: "bg-gray-100 py-16", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold mb-4", children: language === "es" ? "Educación y Certificaciones" : "Education & Certifications" }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "border p-6 rounded-md shadow-md", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-2", children: language === "es" ? "Educación" : "Education" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-800 mb-4", children: content[language].education.degree }),
          /* @__PURE__ */ jsx("img", { src: content[language].education.logo, alt: "Logo de ITSNCG", className: "w-8 h-8 mb-4" }),
          /* @__PURE__ */ jsx("p", { className: "mt-4 text-gray-800", children: content[language].education.institution }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-gray-800", children: content[language].education.average })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "border p-6 rounded-md shadow-md", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-2", children: language === "es" ? "Certificaciones" : "Certifications" }),
          /* @__PURE__ */ jsx("ul", { className: "list-disc text-gray-800 pl-6", children: content[language].certifications.map((cert, index) => /* @__PURE__ */ jsx("li", { className: "mb-2", children: cert }, index)) })
        ] })
      ] })
    ] }) })
  ] }) });
