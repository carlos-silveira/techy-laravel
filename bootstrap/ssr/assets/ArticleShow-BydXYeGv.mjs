...
import { t as BookOpen } from "./book-open-DqyNrb8H.mjs";
...
(/* @__PURE__ */ __name(() => {
	registerLayoutLoaders([
		{
			name: "dagre",
			loader: /* @__PURE__ */ __name(async () => await import("./dagre-3AP2YEHR-BRN0oSAh.mjs"), "loader")
		},
		{
			name: "swimlane",
			loader: /* @__PURE__ */ __name(async () => await import("./swimlanes-XN3QIQJK-GA8MExTg.mjs"), "loader")
		},
		...[{
			name: "cose-bilkent",
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-A5DVABFB-CTfBKdaB.mjs");
		return {
			id: id2,
			diagram: diagram2
		};
...
var detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./swimlanesDiagram-VK2B7HYN-DXL_FtQO.mjs");
		return {
			id: id4,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-SSCWMZ5O-Os7iU57x.mjs");
		return {
			id: id5,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-RXCK75RN-Cs13sF5B.mjs");
		return {
			id: id8,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-E7YTZNPT-B4sveY67.mjs");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-S5SC5T6Z-DR1-OxG1.mjs");
		return {
			id: id11,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-EFPCY7ZU-DG3MlEMO.mjs");
		return {
			id: id12,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-WJ2MYXX4-Bdd2s5pi.mjs");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-DTDB5LWJ-CbrzLh4r.mjs");
		return {
			id: id14,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-JRS7N3AN-DyBeCEEl.mjs");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-HBIQ2CUA-CWen572J.mjs");
		return {
			id: id16,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-4QOOHH4V-C8dqbTnY.mjs");
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-24CTP7MA-DtHckjwm.mjs");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-FBJOCRG2-_tAhm03B.mjs");
		return {
			id: id21,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-3QL26DDD-BaPUtmtI.mjs");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-Z3DM3KII-C0dG_oRZ.mjs");
		return {
			id: id24,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-UQ7AKVKN-B5kJZ6e6.mjs");
		return {
			id: id25,
			diagram: diagram2
		};
...
var detector_default6 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-S7CK7UJ4-CJpgK-b4.mjs");
		return {
			id: id27,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-5GKGNRK7-Do_KVeDa.mjs");
		return {
			id: id28,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-5VMMS53U-C4llXrot.mjs");
		return {
			id: id30,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-4TSXK5OY-CWY2Qk1c.mjs");
		return {
			id: id31,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-VX7I27RA-1P5cd9Na.mjs");
		return {
			id: id32,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./wardleyDiagram-VM6X3IG4-CQdWfbkP.mjs");
		return {
			id: id33,
			diagram: diagram2
		};
...
var cynefin = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./cynefinDiagram-5FMLGOSQ-XfiUMqXt.mjs");
		return {
			id: id34,
			diagram: diagram2
		};
...
var railroad = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./railroadDiagram-O6MQD6OU-D5cikycj.mjs");
		return {
			id: id35,
			diagram: diagram2
		};
...
var railroadEbnf = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ebnfDiagram-PWID7BFC-BW_7i5_D.mjs");
		return {
			id: id36,
			diagram: diagram2
		};
...
var railroadAbnf = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./abnfDiagram-VCTEODGH-BeM8t5wY.mjs");
		return {
			id: id37,
			diagram: diagram2
		};
...
var railroadPeg = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pegDiagram-XKGWAZYB-CrXf5gAf.mjs");
		return {
			id: id38,
			diagram: diagram2
		};
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						className: "mt-12 bg-gray-50 dark:bg-white/[0.02] border border-black/5 dark:border-white/5 rounded-3xl p-6 md:p-10",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
								className: "text-2xl font-black tracking-tighter text-gray-900 dark:text-white mb-8",
								children: [
									"Comments (",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mb-10",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommentForm, { articleId: article.id })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "space-y-6",
								children: article.comments && article.comments.length > 0 ? article.comments.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex gap-4",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "font-black text-primary text-sm uppercase",
											children: c.username.substring(0, 2)
										})
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex-1 bg-white dark:bg-[#0a0f1c] rounded-2xl p-5 border border-black/5 dark:border-white/5 shadow-sm",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											className: "text-sm text-gray-700 dark:text-gray-300 font-light whitespace-pre-wrap",
											children: c.body
										})]
									})]
								}, c.id)) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "text-center text-gray-500 text-sm py-10 font-light bg-white dark:bg-[#0a0f1c] rounded-2xl border border-black/5 dark:border-white/5",
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					children: ["Posting as: ", data.username]
				})
