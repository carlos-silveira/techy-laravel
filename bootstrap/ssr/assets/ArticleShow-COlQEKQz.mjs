...
(/* @__PURE__ */ __name(() => {
	registerLayoutLoaders([
		{
			name: "dagre",
			loader: /* @__PURE__ */ __name(async () => await import("./dagre-3AP2YEHR-DmbC2j64.mjs"), "loader")
		},
		{
			name: "swimlane",
			loader: /* @__PURE__ */ __name(async () => await import("./swimlanes-XN3QIQJK-CwCUT_Se.mjs"), "loader")
		},
		...[{
			name: "cose-bilkent",
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-A5DVABFB-2f5M8hPt.mjs");
		return {
			id: id2,
			diagram: diagram2
		};
...
var detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./swimlanesDiagram-VK2B7HYN-ZqVKs-oY.mjs");
		return {
			id: id4,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-SSCWMZ5O-BZOHh-Ou.mjs");
		return {
			id: id5,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-RXCK75RN-DvrSX0ma.mjs");
		return {
			id: id8,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-E7YTZNPT-fPFx5DKL.mjs");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-S5SC5T6Z-CnUW8elP.mjs");
		return {
			id: id11,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-EFPCY7ZU-Bp73ShPl.mjs");
		return {
			id: id12,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-WJ2MYXX4-CATa8wuS.mjs");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-DTDB5LWJ-CBfftiV1.mjs");
		return {
			id: id14,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-JRS7N3AN-BvH_mb1S.mjs");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-HBIQ2CUA-BErInW6A.mjs");
		return {
			id: id16,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-4QOOHH4V-BwqbG4IZ.mjs");
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-24CTP7MA-CTjfjVhk.mjs");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-FBJOCRG2-D6P6QbZp.mjs");
		return {
			id: id21,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-3QL26DDD-L_-x5kT4.mjs");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-Z3DM3KII-jNH5ifoj.mjs");
		return {
			id: id24,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-UQ7AKVKN-CTpsZihX.mjs");
		return {
			id: id25,
			diagram: diagram2
		};
...
var detector_default6 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-S7CK7UJ4-suO3TQ6b.mjs");
		return {
			id: id27,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-5GKGNRK7-Cl7ZDuh0.mjs");
		return {
			id: id28,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-5VMMS53U-DaCxn3UA.mjs");
		return {
			id: id30,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-4TSXK5OY-DYNVGspC.mjs");
		return {
			id: id31,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-VX7I27RA-DIcVvABp.mjs");
		return {
			id: id32,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./wardleyDiagram-VM6X3IG4-DLynYs2-.mjs");
		return {
			id: id33,
			diagram: diagram2
		};
...
var cynefin = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./cynefinDiagram-5FMLGOSQ-rdCMBv-s.mjs");
		return {
			id: id34,
			diagram: diagram2
		};
...
var railroad = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./railroadDiagram-O6MQD6OU-Cff_83aS.mjs");
		return {
			id: id35,
			diagram: diagram2
		};
...
var railroadEbnf = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ebnfDiagram-PWID7BFC-7m1aPiI4.mjs");
		return {
			id: id36,
			diagram: diagram2
		};
...
var railroadAbnf = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./abnfDiagram-VCTEODGH-DMEPTglv.mjs");
		return {
			id: id37,
			diagram: diagram2
		};
...
var railroadPeg = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pegDiagram-XKGWAZYB-BGkvfh5j.mjs");
		return {
			id: id38,
			diagram: diagram2
		};
