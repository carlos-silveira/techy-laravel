...
(/* @__PURE__ */ __name(() => {
	registerLayoutLoaders([
		{
			name: "dagre",
			loader: /* @__PURE__ */ __name(async () => await import("./dagre-3AP2YEHR-DeyV1B2h.mjs"), "loader")
		},
		{
			name: "swimlane",
			loader: /* @__PURE__ */ __name(async () => await import("./swimlanes-XN3QIQJK-DkCAJWBu.mjs"), "loader")
		},
		...[{
			name: "cose-bilkent",
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-A5DVABFB-DzA2uONU.mjs");
		return {
			id: id2,
			diagram: diagram2
		};
...
var detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./swimlanesDiagram-VK2B7HYN-D_cEKi_9.mjs");
		return {
			id: id4,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-SSCWMZ5O-edkeQIUa.mjs");
		return {
			id: id5,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-RXCK75RN-Djp7XEAc.mjs");
		return {
			id: id8,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-E7YTZNPT-C0RvgFAD.mjs");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-S5SC5T6Z-CGcq2zX9.mjs");
		return {
			id: id11,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-EFPCY7ZU-B5UJXGf8.mjs");
		return {
			id: id12,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-WJ2MYXX4-CWF27QAi.mjs");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-DTDB5LWJ-BABeq1BL.mjs");
		return {
			id: id14,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-JRS7N3AN-7TT605n6.mjs");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-HBIQ2CUA-J1NTfvFk.mjs");
		return {
			id: id16,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-4QOOHH4V-BC8Llent.mjs");
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-24CTP7MA-nK3AHQOs.mjs");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-FBJOCRG2-Bb4XMkqx.mjs");
		return {
			id: id21,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-3QL26DDD-BwoTxGp1.mjs");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-Z3DM3KII-8j6jAFbt.mjs");
		return {
			id: id24,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-UQ7AKVKN-D24Y2rGs.mjs");
		return {
			id: id25,
			diagram: diagram2
		};
...
var detector_default6 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-S7CK7UJ4-BQwVl0JD.mjs");
		return {
			id: id27,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-5GKGNRK7-CDNtK_xU.mjs");
		return {
			id: id28,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-5VMMS53U-D3XwDVnw.mjs");
		return {
			id: id30,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-4TSXK5OY-BG7l9jpi.mjs");
		return {
			id: id31,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-VX7I27RA-DNqoliWo.mjs");
		return {
			id: id32,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./wardleyDiagram-VM6X3IG4-BjDgzjm0.mjs");
		return {
			id: id33,
			diagram: diagram2
		};
...
var cynefin = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./cynefinDiagram-5FMLGOSQ-7vtJqcEW.mjs");
		return {
			id: id34,
			diagram: diagram2
		};
...
var railroad = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./railroadDiagram-O6MQD6OU-Co67Vjvr.mjs");
		return {
			id: id35,
			diagram: diagram2
		};
...
var railroadEbnf = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ebnfDiagram-PWID7BFC-BZkaApMZ.mjs");
		return {
			id: id36,
			diagram: diagram2
		};
...
var railroadAbnf = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./abnfDiagram-VCTEODGH-BJSa3pUP.mjs");
		return {
			id: id37,
			diagram: diagram2
		};
...
var railroadPeg = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pegDiagram-XKGWAZYB-B5jJw8j-.mjs");
		return {
			id: id38,
			diagram: diagram2
		};
