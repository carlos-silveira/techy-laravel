...
import { n as registerLayoutLoaders } from "./chunk-LZXEDZCA-L84VCvVt.mjs";
import { n as load, t as JSON_SCHEMA } from "./chunk-XPW4576I-C8b26R1n.mjs";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./c4Diagram-AAUBKEIU-XFXCG9Jp.mjs");
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-I6XJVG4X-BXbdNWd5.mjs");
		return {
			id: id2,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-TEJ5UH35-BeVbKQ0A.mjs");
		return {
			id: id4,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./gitGraphDiagram-PVQCEYII-DBkiJrhP.mjs");
		return {
			id: id5,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ganttDiagram-6RSMTGT7-D7hJyBkT.mjs");
		return {
			id: id6,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-5YYISTIA-RwUoXV5o.mjs");
		return {
			id: id7,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-4H26LBE5-BacXCh2P.mjs");
		return {
			id: id8,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./quadrantDiagram-W4KKPZXB-D_JrHEK9.mjs");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-2RQKCTM6-C0GlWVsf.mjs");
		return {
			id: id10,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-4Y6WPE33-DdApyBHX.mjs");
		return {
			id: id11,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-3UESZ5HK-CHsAiWnI.mjs");
		return {
			id: id12,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-4FO5ZUOK-Bsetvsx1.mjs");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-Q7XG4LA2-BfOry9PC.mjs");
		return {
			id: id14,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-AJRCARHV-DiiL0msD.mjs");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-BHNVJYJU-aGQa0CmK.mjs");
		return {
			id: id16,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./journeyDiagram-JHISSGLW-CBRDtYdT.mjs");
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-PNZ67QCA-C_7uUysp.mjs");
		return {
			id: id19,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-RKZ34NQL-BfyD49jH.mjs");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-UN3LZRKU-B5q1sGsI.mjs");
		return {
			id: id21,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sankeyDiagram-5OEKKPKP-DZGYdAvr.mjs");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-LMA3HP47-DZnMVHDE.mjs");
		return {
			id: id23,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-2AECGRRQ-RnO6YwZQ.mjs");
		return {
			id: id24,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./blockDiagram-GPEHLZMM-Ch6LbaQv.mjs");
		return {
			id: id25,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-5GNKFQAL-Dpwiv4AL.mjs");
		return {
			id: id26,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-3BPJPVTR-CT6N-Cmu.mjs");
		return {
			id: id27,
			diagram: diagram2
		};
...
var detector_default6 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-KO2AKTUF-DGiT1AyZ.mjs");
		return {
			id: id28,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-YF4QCWOH-DV_POXXP.mjs");
		return {
			id: id29,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-CIIHVFJN-Db8F2kDm.mjs");
		return {
			id: id30,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-OG6HWLK6-D45xPFZg.mjs");
		return {
			id: id31,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./wardleyDiagram-YWT4CUSO-COIYGDRO.mjs");
		return {
			id: id32,
			diagram: diagram2
		};
