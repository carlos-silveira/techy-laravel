	...
	*/
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs(Head, {
				title: `${article.title} - Techy News`,
				children: [
					/* @__PURE__ */ jsx("meta", {
						name: "description",
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("button", {
										...
										children: [/* @__PURE__ */ jsx(Heart, { className: `w-6 h-6 transition-colors ${likes > 0 ? "fill-red-500 text-red-500 shadow-[0_0_15px_rgba(239,68,68,0.3)]" : "text-gray-500 group-hover:text-black dark:group-hover:text-white"}` }), likes > 0 && /* @__PURE__ */ jsx("span", {
