...
import { t as AdsterraAd } from "./AdsterraAd-btgtP4-P.mjs";
import { t as NewsletterBlock } from "./NewsletterBlock-D_zWWSP4.mjs";
//#region resources/js/Pages/Classic.jsx
...
function Welcome({ articles, editorsChoice, dailyBrief, trendingArticles }) {
	...
	const [showCopilot, setShowCopilot] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Head_default, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("title", { children: `${__("Home")} | TechyNews` }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("meta", {
					name: "description",
					content: "TechyNews: Plataforma líder en periodismo tecnológico impulsado por Inteligencia Artificial. Descubre noticias sobre IA, startups, ciberseguridad y el futuro de la tecnología."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("link", {
					rel: "canonical",
					href: "https://techynews.lat"
				}),
            ...
            ` }
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("meta", {
					property: "og:image",
					content: "https://techynews.lat/img/logo_wbc.webp"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("meta", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fixed top-[-20%] right-[-10%] w-[60vw] h-[60vw] bg-primary/8 rounded-full blur-[200px] pointer-events-none mix-blend-screen z-0" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fixed bottom-[-20%] left-[-10%] w-[50vw] h-[50vw] bg-purple-600/8 rounded-full blur-[150px] pointer-events-none mix-blend-screen z-0" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [featured && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-[#f8f6f6] dark:from-[#02040a] via-[#f8f6f6]/80 dark:via-[#02040a]/80 to-transparent" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-r from-[#f8f6f6]/95 dark:from-[#02040a]/95 via-[#f8f6f6]/70 dark:via-[#02040a]/70 to-transparent" })
							]
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: featured && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-2 h-2 rounded-full bg-primary animate-pulse shadow-[0_0_10px_rgba(43,124,238,0.8)]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link_default, {
													...
													children: [__("Read Story"), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "w-4 h-4 group-hover:translate-x-1 transition-transform" })]
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [
														...
														(0, import_dayjs_min.default)(featured.updated_at).fromNow()
													]
												})]
											})
										]
									...
									children: [dailyBrief && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
										initial: {
											opacity: 0,
											scale: .95
										},
									...
									}), trendingArticles?.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
										initial: {
											opacity: 0,
											y: 20
										},
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-1.5 h-1.5 bg-primary rounded-full animate-pulse" }), __("Trending Now")]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "space-y-6",
											children: trendingArticles.map((article, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link_default, {
					...
					editorsChoice && editorsChoice.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
							...
							children: editorsChoice.map((article, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
								initial: {
									opacity: 0,
									y: 20
								},
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link_default, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "h-52 bg-gradient-to-br from-white/10 to-black/50 relative overflow-hidden",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-[#02040a] to-transparent opacity-60" }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 group-hover:bg-amber-400/5 transition-colors duration-500" }),
					...
					articles?.length > 0 && gridArticles.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center gap-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-1 h-8 bg-primary rounded-full" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										].map((cat) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link_default, {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link_default, {
										...
										children: [
											__("Full Archive"),
											" ",
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "w-3 h-3 group-hover:translate-x-1 transition-transform" })
										]
									})
								]
							}),
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link_default, {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: `w-full flex-shrink-0 relative overflow-hidden bg-gray-100 dark:bg-gray-900 ${isLarge ? "h-72" : "h-40"}`,
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-[#02040a] via-transparent to-transparent" }),
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-primary/0 group-hover:bg-primary/10 transition-colors duration-700 mix-blend-overlay" })
													]
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [
														...
														isLarge && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link_default, {
									...
									children: [__("Load All Articles"), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "w-4 h-4 group-hover:translate-x-1 transition-transform" })]
								})
							})
						]
					}) : articles?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						className: "py-20 px-6 max-w-7xl mx-auto border-t border-black/5 dark:border-white/5",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdsterraAd, { type: "320x50" })
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(NewsletterBlock, {}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PublicFooter, {}),
					showCopilot && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Suspense, {
						fallback: null,
