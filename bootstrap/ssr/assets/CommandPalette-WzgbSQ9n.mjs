...
import { i as Link_default, l as axios } from "../ssr.mjs";
import { n as motion } from "./createLucideIcon-Bszla4zf.mjs";
import { i as LoaderCircle, o as AnimatePresence, r as Search, t as X } from "./x-DJSOnP0J.mjs";
				...
				children: [
					...
					results.length === 0 && (!query || query.length < 2) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-center py-6 text-gray-700 flex flex-col items-center gap-2 border-b border-white/5",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-black text-xs uppercase tracking-widest text-gray-400",
								children: "Start typing to search articles..."
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[10px] font-black uppercase tracking-[0.25em] text-gray-500 mb-2 px-2",
							children: "Studio Quick Nav"
							...
							children: [
							...
							].map((shortcut) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link_default, {
								href: shortcut.href,
								onClick: () => setIsOpen(false),
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: shortcut.label }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "w-3.5 h-3.5 text-gray-600" })]
							}, shortcut.href))
						})] })]
					}),
					results.map((article, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link_default, {
						...
						children: [
							getFinalImage(article, 100) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
