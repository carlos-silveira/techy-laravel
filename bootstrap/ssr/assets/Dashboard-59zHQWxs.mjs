...
import { AlignLeft, ArrowLeft, ArrowRight, ArrowUpRight, BarChart2, Bold, Bot, Check, CheckCircle, CheckCircle2, ChevronDown, ChevronLeft, Clock, Code, Copy, Cpu, Edit3, Eye, FileEdit, Globe, Heading2, Heading3, Heart, Home, Image, Italic, Layers, Layout, Link2, List, ListOrdered, Loader2, MessageSquare, Monitor, Newspaper, Quote, Redo, RefreshCw, Rocket, RotateCcw, Search, Send, Share2, Shield, Smartphone, Sparkles, Strikethrough, Tablet, ThumbsUp, Trash2, TrendingDown, TrendingUp, Undo, Users, Wand2, X, Zap } from "lucide-react";
import axios from "axios";
import { Area, AreaChart, Bar, BarChart, CartesianGrid, Cell, Pie, PieChart, ResponsiveContainer, Tooltip, XAxis, YAxis } from "recharts";
import { EditorContent, useEditor } from "@tiptap/react";
import StarterKit from "@tiptap/starter-kit";
//#region resources/js/Components/Skeleton.jsx
...
function StatCard({ icon: Icon, label, value, subValue, trend, color = "blue" }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "bg-white/[0.03] border border-white/5 rounded-2xl p-5 hover:border-white/10 transition-colors group relative overflow-hidden",
		children: [/* @__PURE__ */ jsx("div", { className: `absolute top-0 right-0 w-24 h-24 blur-[40px] rounded-full -mr-10 -mt-10 opacity-10 group-hover:opacity-20 transition-all ${colorClasses.split(" ")[1]}` }), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				subValue && /* @__PURE__ */ jsx("div", {
					className: "text-[9px] text-gray-500 mt-1 font-medium",
					children: subValue
				})
			]
		})]
...
function AnalyticsChart({ analyticsData }) {
	if (!analyticsData) return /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [/* @__PURE__ */ jsx("div", {
			className: "grid grid-cols-2 md:grid-cols-4 gap-4",
			children: [...Array(4)].map((_, i) => /* @__PURE__ */ jsx(Skeleton, { className: "h-28 rounded-2xl" }, i))
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			viewsPerDay && viewsPerDay.length > 0 && /* @__PURE__ */ jsxs("div", {
				className: "bg-white/[0.02] border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-primary/20 transition-colors",
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h3", {
							...
							children: [/* @__PURE__ */ jsxs("span", {
								...
								children: [/* @__PURE__ */ jsx("span", { className: "w-2 h-2 rounded-full bg-primary" }), " Views"]
							}), /* @__PURE__ */ jsxs("span", {
								className: "flex items-center gap-1",
								children: [/* @__PURE__ */ jsx("span", { className: "w-2 h-2 rounded-full bg-purple-500" }), " Unique"]
							})]
						})]
					}),
					/* @__PURE__ */ jsx("div", {
						className: "h-56 w-full relative z-10",
								...
								children: [
									...
									/* @__PURE__ */ jsx(Tooltip, {
										contentStyle: {
											...
											borderColor: "rgba(43,124,238,0.2)",
											borderRadius: "12px",
											color: "#fff",
											fontSize: 12
										},
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [deviceData.length > 0 && /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h3", {
							...
							children: [totalDeviceViews.toLocaleString(), " total hits"]
						})]
					}), /* @__PURE__ */ jsxs("div", {
							...
							children: deviceData.map((d) => {
								...
								return /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsx("span", {
												className: "text-[10px] font-black text-gray-300 tabular-nums w-10 text-right",
											...
											/* @__PURE__ */ jsx("div", {
												...
												children: /* @__PURE__ */ jsx("div", {
													...
													style: {
														...
														backgroundColor: DEVICE_COLORS[d.name] || "#6b7280"
													}
												})
											}),
											/* @__PURE__ */ jsxs("span", {
												className: "text-[10px] font-black text-gray-500 w-12 text-right",
												children: [pct, "%"]
											})
										]
									})]
				...
				}), hourlyTraffic && hourlyTraffic.length > 0 && /* @__PURE__ */ jsxs("div", {
					className: "bg-white/[0.02] border border-white/5 rounded-2xl p-6",
					children: [/* @__PURE__ */ jsx("h3", {
						className: "text-xs font-black text-white uppercase tracking-widest mb-6",
			...
			crawlerDetails && crawlerDetails.length > 0 && /* @__PURE__ */ jsxs("div", {
				className: "bg-white/[0.02] border border-orange-500/10 rounded-3xl p-8 relative overflow-hidden",
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3",
							children: [/* @__PURE__ */ jsx("div", {
								className: "w-8 h-8 rounded-lg bg-orange-500/10 flex items-center justify-center",
								children: /* @__PURE__ */ jsx(Shield, { className: "w-4 h-4 text-orange-400" })
							}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
								className: "text-xs font-black text-orange-400 uppercase tracking-[0.2em]",
								children: "Crawler Intelligence"
							}), /* @__PURE__ */ jsx("p", {
								className: "text-[9px] text-gray-600 font-bold mt-0.5",
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								className: "text-[9px] font-bold text-gray-600 uppercase",
								children: "Bot Hits"
							})]
						})]
					}),
					/* @__PURE__ */ jsx("div", {
						...
						children: crawlerDetails.map((c, i) => /* @__PURE__ */ jsxs("div", {
							className: "bg-white/[0.02] border border-white/5 rounded-xl px-4 py-3 hover:border-orange-500/20 transition-colors",
							children: [
								/* @__PURE__ */ jsx("div", {
									className: "text-[11px] font-bold text-gray-300 truncate",
									children: c.crawler
								}),
								/* @__PURE__ */ jsx("div", {
								...
								/* @__PURE__ */ jsx("div", {
									className: "text-[8px] text-gray-600 font-bold uppercase",
									children: "hits"
								})
							]
						}, i))
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h3", {
						...
						children: "Efficiency Ranking"
					})]
				}), /* @__PURE__ */ jsx("div", {
					className: "space-y-4",
					children: topArticles && topArticles.length > 0 ? topArticles.map((article, i) => /* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-6 group/row hover:bg-white/[0.01] -mx-4 px-4 py-3 rounded-2xl transition-all",
						children: [
							/* @__PURE__ */ jsx("span", {
								className: "text-xl font-black text-white/5 w-8 text-center font-mono group-hover/row:text-primary/20 transition-colors",
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("a", {
									...
									target: "_blank",
									rel: "noreferrer",
									className: "block text-[13px] font-black text-gray-200 group-hover/row:text-primary transition-colors truncate tracking-tight mb-1",
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("div", {
										...
										className: "text-[9px] font-black text-gray-700 uppercase",
										children: "Hits"
									})]
								}), /* @__PURE__ */ jsx("div", {
									className: "w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center border border-white/5 group-hover/row:border-primary/20 transition-colors",
									children: /* @__PURE__ */ jsx(TrendingUp, { className: "w-4 h-4 text-gray-600 group-hover/row:text-primary transition-colors" })
								})]
							})
						]
					}, article.id)) : /* @__PURE__ */ jsxs("div", {
						className: "py-10 text-center",
						children: [/* @__PURE__ */ jsx(Newspaper, { className: "w-8 h-8 text-gray-800 mx-auto mb-2 opacity-20" }), /* @__PURE__ */ jsx("p", {
							className: "text-[11px] font-black text-gray-700 uppercase tracking-widest",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [topPages && topPages.length > 0 && /* @__PURE__ */ jsxs("div", {
					className: "bg-white/[0.02] border border-white/5 rounded-3xl p-8",
					children: [/* @__PURE__ */ jsx("h3", {
						className: "text-[10px] font-black text-white mb-8 uppercase tracking-[0.3em]",
						children: "Entry Points"
					}), /* @__PURE__ */ jsx("div", {
						className: "space-y-3",
						children: topPages.map((page, i) => /* @__PURE__ */ jsxs("div", {
							className: "flex items-center justify-between py-2 border-b border-white/[0.03] last:border-0 group/page",
							children: [/* @__PURE__ */ jsx("span", {
								className: "text-[11px] text-gray-500 font-mono truncate max-w-[70%] group-hover/page:text-gray-300 transition-colors",
								children: page.path
							}), /* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx("div", {
										...
										style: { width: `${Math.min(100, page.views / (topPages[0].views || 1) * 100)}%` }
									})
								}), /* @__PURE__ */ jsx("span", {
									className: "text-[11px] font-black text-gray-400 w-8 text-right",
									children: page.views
								})]
							})]
						}, i))
					})]
				}), topReferrers && topReferrers.length > 0 && /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("h3", {
							className: "text-[10px] font-black text-emerald-400 mb-8 uppercase tracking-[0.3em]",
							children: "Inbound Traffic Sources"
						}),
						/* @__PURE__ */ jsx("div", {
							className: "space-y-3",
							children: topReferrers.map((ref, i) => {
								...
								return /* @__PURE__ */ jsxs("div", {
									className: "flex items-center justify-between py-2 border-b border-white/[0.03] last:border-0 group/ref",
									children: [/* @__PURE__ */ jsxs("div", {
										className: "flex items-center gap-3 min-w-0 flex-1",
										children: [/* @__PURE__ */ jsx("div", {
											className: "w-6 h-6 rounded-md flex items-center justify-center flex-shrink-0",
											style: { backgroundColor: `${refColor}15` },
											children: /* @__PURE__ */ jsx(RefIcon, {
												className: "w-3 h-3",
											...
											className: "min-w-0",
											children: [/* @__PURE__ */ jsx("span", {
												className: "text-[11px] text-gray-300 font-bold tracking-tight block truncate",
												children: ref.source
											}), /* @__PURE__ */ jsx("span", {
										...
										className: "text-[11px] font-black text-emerald-500 tabular-nums flex-shrink-0 ml-3",
										children: ref.views
									})]
								}, i);
							})
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("p", {
							...
							children: "Want new ideas right now?"
						}),
						/* @__PURE__ */ jsx("button", {
							onClick: async () => {
			...
			children: items.length === 0 ? /* @__PURE__ */ jsx("div", {
				className: "text-center py-20 text-gray-500 border border-dashed border-gray-200 dark:border-white/10 rounded-3xl",
				children: "No ideas currently pending. Wait for the agent to find some news."
			}) : items.map((item) => /* @__PURE__ */ jsx("div", {
				className: "p-6 bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5 rounded-3xl transition-all group relative overflow-hidden",
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("h3", {
								className: "font-black text-xl text-gray-900 dark:text-white mb-2",
								children: item.title
							}),
							/* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-4 text-[10px] font-black text-gray-400 dark:text-gray-600 uppercase",
								children: [
									/* @__PURE__ */ jsx("span", {
										className: `px-2 py-1 rounded border inline-block ${item.status === "pending" ? "text-yellow-500 border-yellow-500/20 bg-yellow-500/5" : item.status === "generating" ? "text-primary border-primary/20 bg-primary/5 animate-pulse" : item.status === "published" ? "text-emerald-500 border-emerald-500/20 bg-emerald-500/5" : "text-red-500 border-red-500/20 bg-red-500/5"}`,
							...
							item.status === "failed" && item.error_log && /* @__PURE__ */ jsx("div", {
								className: "mt-4 p-4 bg-red-500/10 border border-red-500/20 rounded-xl text-xs font-mono text-red-400 overflow-x-auto",
						...
						children: [
							...
							item.status === "generating" && /* @__PURE__ */ jsxs("div", {
								className: "px-6 py-4 border border-primary/20 bg-primary/5 rounded-2xl flex flex-col items-center gap-2 text-primary",
								children: [/* @__PURE__ */ jsx(Loader2, { className: "w-5 h-5 animate-spin" }), /* @__PURE__ */ jsx("span", {
									className: "text-[10px] font-black uppercase tracking-widest",
									children: "Wait..."
								})]
							}),
							item.status === "published" && /* @__PURE__ */ jsxs("div", {
								className: "px-6 py-4 border border-emerald-500/20 bg-emerald-500/5 rounded-2xl flex flex-col items-center gap-2 text-emerald-500",
								children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "w-5 h-5" }), /* @__PURE__ */ jsx("span", {
									className: "text-[10px] font-black uppercase tracking-widest",
									children: "Done"
								})]
							})
		...
		children: [
			...
			/* @__PURE__ */ jsxs("aside", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-3 text-gray-400 dark:text-gray-600",
						children: [/* @__PURE__ */ jsx(Cpu, { className: "w-4 h-4" }), /* @__PURE__ */ jsx("span", {
