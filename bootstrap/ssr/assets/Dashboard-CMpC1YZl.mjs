...
import { AlignLeft, ArrowLeft, ArrowRight, BarChart2, Bold, Bot, Check, CheckCircle, CheckCircle2, ChevronDown, ChevronLeft, Clock, Code, Copy, Cpu, Edit3, Eye, FileEdit, Globe, Heading2, Heading3, Heart, Home, Image, Italic, Layers, Layout, List, ListOrdered, Loader2, MessageSquare, Monitor, Newspaper, Quote, Radar, Redo, RefreshCw, Rocket, RotateCcw, Search, Send, Shield, Smartphone, Sparkles, Strikethrough, Tablet, ThumbsUp, Trash2, TrendingDown, TrendingUp, Undo, Users, Wand2, X, Zap } from "lucide-react";
...
function StatCard({ icon: Icon, label, value, subValue, trend, color = "blue" }) {
	...
	return /* @__PURE__ */ jsxs(motion.div, {
		...
		children: [/* @__PURE__ */ jsx("div", { className: `absolute top-0 right-0 w-24 h-24 blur-[40px] rounded-full -mr-10 -mt-10 opacity-10 group-hover:opacity-30 transition-all duration-500 ${colorClasses.split(" ")[1]}` }), /* @__PURE__ */ jsxs("div", {
