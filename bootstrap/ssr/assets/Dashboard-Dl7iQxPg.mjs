	...
	return /* @__PURE__ */ jsxs(motion.div, {
		...
		children: [
			...
			stats.topLikedArticles && stats.topLikedArticles.length > 0 && /* @__PURE__ */ jsxs(motion.div, {
				variants: itemVariants,
				className: "bg-pink-500/5 border border-pink-500/10 dark:border-pink-500/20 rounded-3xl p-8 backdrop-blur-md",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "flex items-center justify-between mb-8",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-3",
						children: [/* @__PURE__ */ jsx("div", {
							className: "w-8 h-8 rounded-xl bg-pink-500/20 flex items-center justify-center",
							children: /* @__PURE__ */ jsx(Heart, { className: "w-4 h-4 text-pink-500" })
						}), /* @__PURE__ */ jsx("h3", {
							className: "text-[10px] font-black text-pink-500 uppercase tracking-[0.3em]",
							children: "Most Liked Content"
						})]
					}), /* @__PURE__ */ jsx("div", {
						className: "text-[10px] font-bold text-pink-500/70 uppercase tracking-widest bg-pink-500/10 px-3 py-1.5 rounded-lg",
						children: "All Time"
					})]
				}), /* @__PURE__ */ jsx("div", {
					className: "space-y-2",
					children: stats.topLikedArticles.map((article, i) => /* @__PURE__ */ jsxs(motion.div, {
						...
						className: "flex items-center gap-6 group/row hover:bg-pink-500/10 -mx-4 px-4 py-4 rounded-2xl transition-all cursor-pointer",
						children: [
							/* @__PURE__ */ jsx("span", {
								className: "text-xl font-black text-pink-500/30 w-8 text-center font-mono group-hover/row:text-pink-500 transition-colors",
								children: String(i + 1).padStart(2, "0")
							}),
							/* @__PURE__ */ jsx("div", {
								className: "flex-1 min-w-0",
								children: /* @__PURE__ */ jsx("a", {
									...
									target: "_blank",
									rel: "noreferrer",
									className: "block text-sm font-black text-gray-900 dark:text-white group-hover/row:text-pink-500 transition-colors truncate tracking-tight mb-1",
									children: article.title
								})
							}),
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("div", {
										...
										className: "text-[9px] font-black text-pink-500/50 uppercase tracking-widest mt-0.5",
										children: "Likes"
									})]
								})
							})
			...
			stats.adsenseProjection && /* @__PURE__ */ jsxs(motion.div, {
				variants: itemVariants,
				className: "bg-emerald-500/5 border border-emerald-500/10 dark:border-emerald-500/20 rounded-3xl p-8 backdrop-blur-md mt-6",
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3",
							children: [/* @__PURE__ */ jsx("div", {
								className: "w-8 h-8 rounded-xl bg-emerald-500/20 flex items-center justify-center",
								children: /* @__PURE__ */ jsx(DollarSign, { className: "w-4 h-4 text-emerald-500" })
							}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
								className: "text-[10px] font-black text-emerald-600 dark:text-emerald-500 uppercase tracking-[0.3em]",
								children: "Monetization Forecast"
							}), /* @__PURE__ */ jsx("p", {
								className: "text-[9px] font-bold text-emerald-500/70 uppercase tracking-widest mt-0.5",
								children: "Google AdSense Projections (30 Days)"
							})] })]
						}), /* @__PURE__ */ jsxs("div", {
							className: "text-[10px] font-bold text-emerald-500/70 uppercase tracking-widest bg-emerald-500/10 px-3 py-1.5 rounded-lg",
							children: [
								"Based on ",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "bg-white/50 dark:bg-black/20 border border-emerald-500/10 rounded-2xl p-5",
								children: [/* @__PURE__ */ jsx("div", {
									className: "text-[10px] font-black text-emerald-500/60 uppercase tracking-widest mb-1",
									children: "Low Estimate (RPM $1.50)"
								}), /* @__PURE__ */ jsxs("div", {
							...
							/* @__PURE__ */ jsxs("div", {
								className: "bg-emerald-500/10 border border-emerald-500/30 rounded-2xl p-5 relative overflow-hidden",
								children: [
									/* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-24 h-24 bg-emerald-500/20 blur-[30px] rounded-full pointer-events-none -mr-10 -mt-10" }),
									/* @__PURE__ */ jsx("div", {
										className: "text-[10px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mb-1 relative z-10",
										children: "Avg Estimate (RPM $2.75)"
									}),
									/* @__PURE__ */ jsxs("div", {
										className: "text-3xl font-black text-emerald-600 dark:text-emerald-400 relative z-10",
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									className: "text-[10px] font-black text-emerald-500/60 uppercase tracking-widest mb-1",
									children: "High Estimate (RPM $4.00)"
								}), /* @__PURE__ */ jsxs("div", {
									className: "text-2xl font-black text-gray-900 dark:text-white",
					...
					/* @__PURE__ */ jsx("p", {
						className: "text-[10px] font-medium text-gray-500 mt-6 max-w-2xl",
						children: "* Estimates assume standard tech-niche RPMs (Revenue Per Mille) ranging from $1.50 to $4.00. Actual AdSense revenue varies heavily based on traffic geography (e.g. US traffic pays significantly more than LATAM), ad placement density, and user engagement."
					})
				]
			})
		]
