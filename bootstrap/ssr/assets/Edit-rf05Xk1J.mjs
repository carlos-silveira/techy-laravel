...
import { i as LoaderCircle, n as Sparkles } from "./x-DJSOnP0J.mjs";
import { s as CircleCheck } from "./users-DrThxkpH.mjs";
...
import { t as Bot } from "./bot-CRBEpcr3.mjs";
import { t as StudioLayout } from "./StudioLayout-B9skejwH.mjs";
import { t as Send } from "./send-BkLYY7uF.mjs";
import { t as ExternalLink } from "./external-link-Bj33m3Kk.mjs";
import { t as Save } from "./save-CeMkGkze.mjs";
import { t as Trash2 } from "./trash-2-BD4KwINw.mjs";
import { t as Upload } from "./upload-BSz0eqoe.mjs";
...
function ArticlesEdit({ article }) {
	...
	const handleImageUpload = async (e) => {
		...
		try {
			const res = await axios.post("/upload-image", formData, { headers: { "Content-Type": "multipart/form-data" } });
