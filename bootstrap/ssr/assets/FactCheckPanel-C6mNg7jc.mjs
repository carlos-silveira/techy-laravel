...
import { c as require_react_dom, l as axios, n as toast } from "../ssr.mjs";
import { n as motion, t as createLucideIcon } from "./createLucideIcon-Bszla4zf.mjs";
import { a as AnimatePresence } from "./x-Dbgsofub.mjs";
import { r as ShieldCheck } from "./users-DrThxkpH.mjs";
import { t as ChevronDown } from "./chevron-down-Bp-PMhzG.mjs";
import { t as CircleCheckBig } from "./circle-check-big-pAhfCZ4b.mjs";
import { t as ExternalLink } from "./external-link-Bj33m3Kk.mjs";
import { t as LoaderCircle } from "./loader-circle-BtTQKIZW.mjs";
import { t as RefreshCw } from "./refresh-cw-BGcTavJt.mjs";
import { t as ShieldAlert } from "./shield-alert-DLMxf6Si.mjs";
import { n as ShieldX, t as WandSparkles } from "./wand-sparkles-DMIBlR_v.mjs";
...
* See the LICENSE file in the root directory of this source tree.
*/
var Bold$1 = createLucideIcon("Bold", [["path", {
...
* See the LICENSE file in the root directory of this source tree.
*/
var Code$1 = createLucideIcon("Code", [["polyline", {
...
* See the LICENSE file in the root directory of this source tree.
*/
var Italic$1 = createLucideIcon("Italic", [
	["line", {
		x1: "19",
		x2: "10",
		y1: "4",
...
if (process.env.NODE_ENV === "production") shim.exports = requireUseSyncExternalStoreShim_production_min();
...
if (process.env.NODE_ENV === "production") withSelector.exports = requireWithSelector_production_min();
else withSelector.exports = requireWithSelector_development();
...
var AIMenu = ({ editor }) => {
	...
	const [currentAction, setCurrentAction] = (0, import_react.useState)("");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [
				isGenerating ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "w-3 h-3 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "w-3 h-3" }),
				isGenerating ? currentAction : "AI Tools",
				!isGenerating && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "w-3 h-3 ml-1" })
			]
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlignLeft, { className: "w-4 h-4 text-primary" }), " Auto-Complete"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: () => handleAction("summarize", "Summarizing..."),
						className: "flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white rounded-lg transition-colors text-left w-full pointer-events-auto",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilePen, { className: "w-4 h-4 text-purple-400" }), " Summarize Section"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: () => handleAction("professional", "Refining..."),
						className: "flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white rounded-lg transition-colors text-left w-full pointer-events-auto",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WandSparkles, { className: "w-4 h-4 text-blue-400" }), " Make Professional"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: () => handleAction("fix_grammar", "Correcting..."),
						className: "flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white rounded-lg transition-colors text-left w-full pointer-events-auto",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheckBig, { className: "w-4 h-4 text-green-400" }), " Fix Grammar"]
					})
				]
			})]
		})]
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Undo, { className: "w-4 h-4" })
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					onClick: () => editor.chain().focus().redo().run(),
					disabled: !editor.can().redo(),
					className: "p-2 rounded-xl text-gray-500 hover:text-white disabled:opacity-30 pointer-events-auto",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Redo, { className: "w-4 h-4" })
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex gap-1 border-r border-white/10 pr-2",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bold$1, { className: "w-4 h-4" })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => editor.chain().focus().toggleItalic().run(),
						className: btnClass(editor.isActive("italic")),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Italic$1, { className: "w-4 h-4" })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => editor.chain().focus().toggleStrike().run(),
						className: btnClass(editor.isActive("strike")),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Strikethrough, { className: "w-4 h-4" })
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heading2, { className: "w-4 h-4" })
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					onClick: () => editor.chain().focus().toggleHeading({ level: 3 }).run(),
					className: btnClass(editor.isActive("heading", { level: 3 })),
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heading3, { className: "w-4 h-4" })
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex gap-1 border-r border-white/10 pr-2",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Quote, { className: "w-4 h-4" })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => editor.chain().focus().toggleCodeBlock().run(),
						className: btnClass(editor.isActive("codeBlock")),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Code$1, { className: "w-4 h-4" })
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex-grow" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AIMenu, { editor })
		]
	});
};
function RichEditor({ initialContent, onChange, keyTrigger }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuBar, { editor }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
//#region resources/js/Components/FactCheckPanel.jsx
function FactCheckPanel({ articleId }) {
	const [factCheck, setFactCheck] = (0, import_react.useState)(null);
	const [isLoading, setIsLoading] = (0, import_react.useState)(true);
	const [isTriggering, setIsTriggering] = (0, import_react.useState)(false);
	const [expandedClaims, setExpandedClaims] = (0, import_react.useState)({});
	(0, import_react.useEffect)(() => {
		if (articleId) fetchFactCheck();
		else {
			setFactCheck(null);
			setIsLoading(false);
		}
	...
	const fetchFactCheck = async () => {
		...
		try {
			...
			if (error.response?.status !== 404) toast.error("Failed to load fact check data.");
			setFactCheck(null);
		} finally {
			setIsLoading(false);
		}
	...
	if (isLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 flex items-center justify-center animate-pulse",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center gap-2 text-gray-500",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "w-5 h-5 animate-spin" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Loading fact-check data..." })]
		})
	});
	if (!factCheck) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex flex-col items-center text-center space-y-4",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "w-16 h-16 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "w-8 h-8 text-gray-400" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					className: "font-bold text-lg",
					children: "No Fact-Check Data"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-gray-500 text-sm max-w-md mx-auto mt-1",
					children: "This article hasn't been verified against our trusted sources database yet."
				})] }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [isTriggering ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { className: "w-4 h-4" }), isTriggering ? "Verifying..." : "Run Fact-Check"]
				})
			]
		})
	});
	...
	const getStatusIcon = (status) => {
		switch (status) {
			case "passed": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "w-10 h-10 text-emerald-500" });
			case "needs_review": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, { className: "w-10 h-10 text-amber-500" });
			case "failed": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldX, { className: "w-10 h-10 text-red-500" });
			default: return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "w-10 h-10 text-primary animate-spin" });
		}
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "p-6 border-b border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-6",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-4",
					children: [getStatusIcon(factCheck.status), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-xs text-gray-500 uppercase tracking-widest font-bold mb-1",
							children: "Fact-Check Status"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "font-bold text-xl capitalize",
							children: factCheck.status.replace("_", " ")
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-sm text-gray-400 mt-1",
							children: ["Checked ", new Date(factCheck.checked_at).toLocaleString()]
						})
					] })]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-6",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: `w-20 h-20 rounded-full border-4 flex items-center justify-center font-black text-2xl ${getScoreColor(factCheck.overall_score)}`,
						children: factCheck.overall_score
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						onClick: triggerFactCheck,
						disabled: isTriggering,
						className: "p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-all disabled:opacity-50",
						title: "Re-run fact check",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { className: `w-5 h-5 ${isTriggering ? "animate-spin" : ""}` })
					})]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid grid-cols-3 divide-x divide-white/5 border-b border-white/5 bg-black/20",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "p-4 text-center",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-2xl font-bold",
							children: factCheck.claims_count
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-xs text-gray-500 uppercase tracking-wider",
							children: "Claims Extracted"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "p-4 text-center",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: factCheck.verified_count
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-xs text-gray-500 uppercase tracking-wider",
							children: "Verified"
						})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: factCheck.failed_count
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-xs text-gray-500 uppercase tracking-wider",
							children: "Failed"
						})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
					...
					children: "Detailed Audit Trail"
				}), !factCheck.claims || factCheck.claims.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-gray-500 italic",
					children: "No specific verifiable claims were extracted from this article."
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "space-y-3",
					children: factCheck.claims.map((claim, idx) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "border border-white/5 rounded-xl overflow-hidden bg-black/10",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: () => toggleClaim(idx),
								className: "w-full text-left p-4 flex items-start gap-4 hover:bg-white/5 transition-colors",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: `px-2 py-1 rounded text-xs font-bold uppercase border ${verdictColor} shrink-0 mt-0.5`,
										children: claim.verdict.replace("_", " ")
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex-1 text-sm font-medium pr-4",
										children: [
											"\"",
											claim.claim_text,
											"\""
									...
									isExpanded ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronUp, { className: "w-5 h-5 text-gray-500 shrink-0" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "w-5 h-5 text-gray-500 shrink-0" })
								]
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: claim.ai_explanation || "No explanation provided."
										})] }),
										claim.supporting_sources && claim.supporting_sources.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-gray-500 uppercase text-xs font-bold block mb-2",
											children: "Supporting Sources"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "space-y-2",
											children: claim.supporting_sources.map((src, sIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
												href: src.url,
												target: "_blank",
												rel: "noreferrer",
												className: "flex items-center gap-2 text-primary hover:underline bg-primary/5 p-2 rounded-lg border border-primary/10",
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "w-4 h-4 shrink-0" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "truncate flex-1",
														children: src.domain
													}),
													src.tier && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
														className: "text-[10px] bg-primary/20 text-primary px-2 py-0.5 rounded-full shrink-0",
														children: ["Tier ", src.tier]
													})
												]
											}, sIdx))
										})] }),
										claim.contradicting_sources && claim.contradicting_sources.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-gray-500 uppercase text-xs font-bold block mb-2",
											children: "Contradicting Sources"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "space-y-2",
											children: claim.contradicting_sources.map((src, sIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
												href: src.url,
												target: "_blank",
												rel: "noreferrer",
												className: "flex items-center gap-2 text-red-400 hover:underline bg-red-500/10 p-2 rounded-lg border border-red-500/20",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "w-4 h-4 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "truncate flex-1",
													children: src.domain
												})]
											}, sIdx))
...
//#endregion
export { RichEditor as n, FactCheckPanel as t };
