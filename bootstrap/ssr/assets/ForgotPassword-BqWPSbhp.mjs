    ...
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white/[0.03] border border-white/10 rounded-[2.5rem] p-10 shadow-[0_30px_80px_rgba(0,0,0,0.5)]", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center", children: /* @__PURE__ */ jsx(Mail, { className: "w-4 h-4 text-primary" }) }),
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-primary", children: "Password Reset" })
              ] }),
              /* @__PURE__ */ jsx("h1", { className: "text-3xl font-black tracking-tighter", children: "Forgot password?" }),
              /* @__PURE__ */ jsx("p", { className: "text-gray-500 font-light mt-2 text-sm leading-relaxed", children: "No worries. Enter your email and we'll send you a reset link." })
            ] }),
            ...
            /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5", children: [
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    processing ? /* @__PURE__ */ jsx("span", { className: "w-4 h-4 border-2 border-black/20 border-t-black rounded-full animate-spin" }) : /* @__PURE__ */ jsx(Mail, { className: "w-4 h-4" }),
          ...
          /* @__PURE__ */ jsx("p", { className: "text-center text-[10px] font-black uppercase tracking-widest text-gray-700 mt-8", children: /* @__PURE__ */ jsxs(Link, { href: "/login", className: "hover:text-gray-500 transition-colors flex items-center justify-center gap-1", children: [
