				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											...
											children: /* @__PURE__ */ jsx(Mail, { className: "w-4 h-4 text-primary" })
										}), /* @__PURE__ */ jsx("span", {
							...
							Object.keys(errors).length > 0 && /* @__PURE__ */ jsx("div", {
								className: "mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-2xl",
								children: Object.values(errors).map((err, i) => /* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsxs("form", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
									...
									className: "relative",
									children: [/* @__PURE__ */ jsx(Mail, { className: "absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-600" }), /* @__PURE__ */ jsx("input", {
										type: "email",
										name: "email",
										value: data.email,
									...
									children: [processing ? /* @__PURE__ */ jsx("span", { className: "w-4 h-4 border-2 border-black/20 border-t-black rounded-full animate-spin" }) : /* @__PURE__ */ jsx(Mail, { className: "w-4 h-4" }), processing ? "Sending..." : "Send Reset Link"]
								})]
							})
						]
					}),
					/* @__PURE__ */ jsx("p", {
						...
						children: /* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "w-3 h-3" }), " Back to Login"]
						})
					})
				]
			})
