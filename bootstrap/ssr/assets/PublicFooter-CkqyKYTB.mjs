...
import { a as router3, i as Link_default, l as axios, n as toast } from "../ssr.mjs";
...
function PushSubscribe() {
	...
	const checkSubscription = async () => {
		try {
			setIsSubscribed(!!await (await navigator.serviceWorker.register("/sw.js")).pushManager.getSubscription());
		} catch (e) {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								"aria-label": "Search",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "w-5 h-5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-[10px] font-black uppercase tracking-widest hidden xl:block opacity-60 group-hover:opacity-100 transition-opacity",
									children: "CMD K"
								})]
							}),
