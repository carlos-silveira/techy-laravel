...
import { c as xe, i as At, n as toast, t as require_jsx_runtime, u as require_react } from "../ssr.mjs";
import { n as motion, t as createLucideIcon } from "./createLucideIcon-DugaG8X6.mjs";
import { a as ChevronDown, c as AnimatePresence, i as Globe, n as useLanguage, o as Check, r as X, s as ArrowRight, t as ThemeToggle } from "./ThemeToggle-B3J0Nc59.mjs";
...
function LanguageSwitcher() {
	...
	const changeLanguage = (langCode) => {
		setIsOpen(false);
		At.post("/set-locale", { locale: langCode }, {
			preserveScroll: true,
			onSuccess: () => {
...
function Navbar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: navLinks.map((link) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(xe, {
							href: link.href,
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-px w-full bg-black/5 dark:bg-white/5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(xe, {
				href: "/dashboard",
				onClick: () => setIsMenuOpen(false),
