...
//#region resources/js/Pages/Terms.jsx
function Terms() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(Head, { title: `${__("Terms of Use")} | Techy News` }),
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h1", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("p", { children: __("Welcome to Techy News (techynews.lat). By accessing or using our website, you agree to be bound by these Terms of Use and our Privacy Policy. If you do not agree with any part of these terms, please do not use our platform.") }),
							/* @__PURE__ */ jsxs("h2", { children: ["1. ", __("Use of Content")] }),
							...
							/* @__PURE__ */ jsxs("h2", { children: ["2. ", __("Artificial Intelligence Disclaimer")] }),
							...
							/* @__PURE__ */ jsxs("h2", { children: ["3. ", __("User Conduct")] }),
							/* @__PURE__ */ jsx("p", { children: __("When accessing our platform, you agree not to engage in any activity that disrupts the website's infrastructure, such as automated scraping, denial of service attacks, or probing vulnerabilities in our systems.") }),
							/* @__PURE__ */ jsxs("h2", { children: ["4. ", __("Third-Party Links")] }),
							/* @__PURE__ */ jsx("p", { children: __("Our articles may occasionally contain outbound links to third-party sources or external research. We have no control over the content and practices of these sites and cannot accept responsibility for their respective privacy policies or terms.") }),
							/* @__PURE__ */ jsxs("h2", { children: ["5. ", __("Changes to Terms")] }),
							/* @__PURE__ */ jsx("p", { children: __("Techy News reserves the right to modify these Terms at any time. We will indicate modifications by updating the \"Last Updated\" date at the top of this document. Continued use of the platform after changes have been posted constitutes your acceptance of the revised Terms.") })
						]
					})]
				})
			}),
