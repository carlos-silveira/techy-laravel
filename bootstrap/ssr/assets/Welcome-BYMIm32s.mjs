								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
											className: "text-2xl md:text-5xl font-black line-clamp-4 md:line-clamp-none tracking-tighter leading-tight md:leading-[1.1] mb-4 md:mb-6 text-white drop-shadow-lg",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "mb-4 md:mb-6 bg-white/10 backdrop-blur-xl transform-gpu border border-white/20 p-4 md:p-5 rounded-2xl shadow-xl max-h-[35vh] md:max-h-none overflow-y-auto overscroll-contain",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: (article.ai_summary || "").split(". ").slice(0, 3).map((sentence, i) => sentence && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
													className: "text-white text-[15px] md:text-xl font-medium leading-snug md:leading-loose flex items-start gap-3",
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "text-primary mt-0.5 md:mt-1.5 text-lg md:text-2xl",
															children: "•"
														}),
														sentence,
														!sentence.endsWith(".") ? "." : ""
