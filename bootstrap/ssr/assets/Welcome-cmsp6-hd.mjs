...
function ReelsDemo({ articles: initialArticlesData }) {
	...
	const trackedViews = (0, import_react.useRef)(/* @__PURE__ */ new Set());
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "bg-black text-white h-[100dvh] w-screen overflow-hidden font-sans selection:bg-primary/30 relative",
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: feedItems.map((item, index) => {
					...
					if (item.type === "footer") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "w-full snap-start snap-always bg-[#02040a]",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PublicFooter, {})
					}, item.id);
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "absolute inset-0 z-10 flex flex-col justify-center md:justify-end p-4 md:p-10 lg:p-16 pb-6 md:pb-12 pt-20 md:pt-24 w-full max-w-6xl mx-auto",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
											className: "text-2xl md:text-4xl lg:text-5xl font-black line-clamp-4 md:line-clamp-3 tracking-tighter leading-tight md:leading-[1.15] mb-3 md:mb-5 text-white drop-shadow-lg",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "mb-4 md:mb-6 bg-white/10 backdrop-blur-xl transform-gpu border border-white/20 p-3.5 md:p-6 rounded-2xl shadow-xl max-h-[40vh] lg:max-h-none overflow-y-auto overscroll-contain",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: (article.ai_summary || "").split(". ").slice(0, 3).map((sentence, i) => sentence && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
													className: "text-white text-[14px] md:text-lg font-medium leading-snug md:leading-relaxed flex items-start gap-3",
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "text-primary mt-0.5 md:mt-1 text-lg md:text-xl",
															children: "•"
														}),
														sentence,
														!sentence.endsWith(".") ? "." : ""
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex flex-row items-center gap-2 md:gap-4 mt-1 md:mt-6",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link_default, {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "w-4 h-4 md:w-5 md:h-5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "truncate",
														children: __("Read Full Story")
													})]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													className: "flex-none inline-flex items-center gap-1.5 text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-300 bg-white/10 backdrop-blur-md transform-gpu px-3 py-2.5 md:px-4 md:py-2 rounded-full border border-white/10",
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "w-3.5 h-3.5 text-primary" }),
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
															className: "sm:hidden",
															children: [article.reading_time_minutes || 5, "m"]
														})
													]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "hidden md:inline-flex text-xs font-bold uppercase tracking-widest text-gray-300 opacity-70 bg-black/40 backdrop-blur-md transform-gpu px-4 py-2 rounded-full border border-white/5",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "absolute right-3 bottom-6 md:right-10 md:bottom-12 z-20 flex flex-col gap-4 md:gap-5 items-center",
								children: [
