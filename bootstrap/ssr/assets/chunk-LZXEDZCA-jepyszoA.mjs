...
import { b as getConfig, s as common_default } from "./chunk-CSCIHK7Q-R3DnWyyv.mjs";
import { d as interpolateToCurve } from "./chunk-5ZQYHXKU-DYNWrQ9x.mjs";
import { a as insertNode, i as insertCluster, s as labelHelper } from "./chunk-3OPIFGDE-CBIi0WiP.mjs";
import { a as positionEdgeLabel, i as markers_default, n as insertEdge, r as insertEdgeLabel } from "./chunk-KSCS5N6A-lGHSO2qc.mjs";
...
(/* @__PURE__ */ __name(() => {
	registerLayoutLoaders([{
		name: "dagre",
		loader: /* @__PURE__ */ __name(async () => await import("./dagre-BM42HDAG-BU4z9WKb.mjs"), "loader")
	}, ...[{
		name: "cose-bilkent",
		loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-S5V4N54A-DCNrVJ2J.mjs"), "loader")
	}]]);
