            ...
            <main className="max-w-7xl mx-auto px-6 py-20 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[minmax(200px,auto)]">
                    ...
                    <motion.div
                        ...
                        className="md:col-span-2 bg-white text-black rounded-[2.5rem] p-10 flex flex-col justify-center items-center text-center group cursor-pointer hover:bg-gray-100 transition-colors"
                    >
                        <h2 className="text-3xl font-black tracking-tight mb-2">Have a radical idea?</h2>
                        <p className="text-gray-600 mb-6 font-medium">Let's build the next era of digital intelligence together.</p>
                        <a href="mailto:hello@carlossilveira.com" className="px-8 py-3 bg-black text-white rounded-xl font-black flex items-center gap-2 hover:scale-105 transition-transform text-sm">
