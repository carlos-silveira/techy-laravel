                    ...
                    >
                        ...
                        <div className="bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-[2rem] p-8 md:p-12 shadow-sm dark:shadow-none">
                            <p className="text-[16px] text-gray-700 dark:text-gray-300 font-light leading-[1.8] mb-6">
                                {__('At TechyNews, our goal is to deliver timely, accurate, and insightful technology news at scale. To achieve this, we operate as an automated AI-driven news aggregator.')}
                            </p>
                            <h3 className="text-[20px] font-medium text-black dark:text-white mb-4">{__('AI-Driven Content Generation')}</h3>
                            <p className="text-[16px] text-gray-700 dark:text-gray-300 font-light leading-[1.8] mb-6">
                                {__('Our platform utilizes advanced artificial intelligence models (such as Google Gemini) to autonomously monitor multiple authoritative tech sources, draft summaries, translate content, and format the articles you read. The entire pipeline—from news discovery to publication—is managed by AI algorithms.')}
                            </p>
                            <h3 className="text-[20px] font-medium text-black dark:text-white mb-4">{__('Automated Fact-Checking')}</h3>
                            <p className="text-[16px] text-gray-700 dark:text-gray-300 font-light leading-[1.8] mb-6">
                                {__('We do not employ a human editorial team for manual fact-checking or reading every article before publication. Instead, we rely on the reasoning capabilities of state-of-the-art LLMs to cross-reference data and extract the most relevant information directly from primary sources.')}
                            </p>
